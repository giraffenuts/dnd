...
A newly found rod typically has `dice:1d10|noform|avg` (`1d10`) levels of spell energy stored in it. A rod that can no longer absorb spell energy and has no energy remaining becomes nonmagical.
