...
# Dragon Slayer
*Rare*  
![](3-Compendium/items/img/dragon-slayer.webp#right)


You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon.

The weapon deals an extra `dice:3d6|noform|avg` (`3d6`) damage of the weapon's type if the target is a Dragon.
