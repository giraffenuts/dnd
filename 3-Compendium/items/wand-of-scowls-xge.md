...
The wand regains all expended charges daily at dawn. If you expend the wand's last charge, roll a `dice:d20|noform|avg` (`d20`). On a 1, the wand transforms into a [wand of smiles](3-Compendium/items/wand-of-smiles-xge.md).
