...
# Vicious Weapon
*Rare*  
![](3-Compendium/items/img/vicious-weapon.webp#right)


This magic weapon deals an extra `dice:2d6|noform|avg` (`2d6`) damage to any creature it hits. This extra damage is of the same type as the weapon's normal damage.
