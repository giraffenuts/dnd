...
# Mariner's Armor
*Uncommon*  
![](3-Compendium/items/img/mariners-armor.webp#right)


While wearing this armor, you have a [Swim Speed](3-Compendium/rules/variant-rules/swim-speed-xphb.md) equal to your [Speed](3-Compendium/rules/variant-rules/speed-xphb.md). In addition, if you start your turn underwater with 0 [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md), you immediately regain `dice:1d4|noform|avg` (`1d4`) [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md). The armor can't heal anyone again until the next dawn.
