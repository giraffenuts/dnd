...
# Giant Slayer
*Rare*  
![](3-Compendium/items/img/giant-slayer.webp#right)


You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon.

When you hit a Giant with this weapon, the Giant takes an extra `dice:2d6|noform|avg` (`2d6`) damage of the weapon's type and must succeed on a DC 15 Strength saving throw or have the [Prone](3-Compendium/rules/conditions.md#Prone) condition.
