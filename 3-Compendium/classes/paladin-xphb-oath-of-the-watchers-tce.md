...
|---------------|--------|
| 3rd | [alarm](3-Compendium/spells/alarm-xphb.md), [detect magic](3-Compendium/spells/detect-magic-xphb.md) |
| 5th | [moonbeam](3-Compendium/spells/moonbeam-xphb.md), [see invisibility](3-Compendium/spells/see-invisibility-xphb.md) |
| 9th | [counterspell](3-Compendium/spells/counterspell-xphb.md), [nondetection](3-Compendium/spells/nondetection-xphb.md) |
| 13th | [aura of purity](3-Compendium/spells/aura-of-purity-xphb.md), [banishment](3-Compendium/spells/banishment-xphb.md) |
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly end its move in a space within 30 feet of you. For its action, it can use only the [Dash](3-Compendium/rules/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can take the [Dodge](3-Compendium/rules/actions.md#Dodge) action.

### Aura of the Sentinel (Level 7)

*7th-level Oath of the Watchers feature*

You emit an aura of alertness while you aren't [incapacitated](3-Compendium/rules/conditions.md#Incapacitated). When you and any creatures of your choice within 10 feet of you roll initiative, you all gain a bonus to initiative equal to your proficiency bonus.
...
- You gain [truesight](3-Compendium/rules/senses.md#Truesight) with a range of 120 feet.  
