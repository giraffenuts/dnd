...
At 3rd level, you learn magical theory or some of the secrets of nature—typical for practitioners of this elven martial tradition. You choose to gain proficiency in either the [Arcana](3-Compendium/rules/skills.md#Arcana) or the [Nature](3-Compendium/rules/skills.md#Nature) skill, and you choose to learn either the [prestidigitation](3-Compendium/spells/prestidigitation-xphb.md) or the [druidcraft](3-Compendium/spells/druidcraft-xphb.md) cantrip.

### Arcane Shot (Level 3)

At 3rd level, you learn to unleash special magical effects with some of your shots. When you gain this feature, you learn two Arcane Shot options of your choice (see "Arcane Shot Options" below).

Once per turn when you fire an arrow from a shortbow or longbow as part of the [Attack](3-Compendium/rules/actions.md#Attack) action, you can apply one of your Arcane Shot options to that arrow. You decide to use the option when the arrow hits a creature, unless the option doesn't involve an attack roll. You have two uses of this ability, and you regain all expended uses of it when you finish a short or long rest.
...
> ![Arcane Shot](3-Compendium/lists/list-optfeaturetype-as.md#Arcane%20Shot)
^list-optfeature-as