...
- **Tools**: none
- **Skills**: Two skills of your choice from the following list: [Acrobatics](3-Compendium/rules/skills.md#Acrobatics), [Animal Handling](3-Compendium/rules/skills.md#Animal%20Handling), [Athletics](3-Compendium/rules/skills.md#Athletics), [Intimidation](3-Compendium/rules/skills.md#Intimidation), [Nature](3-Compendium/rules/skills.md#Nature), [Perception](3-Compendium/rules/skills.md#Perception), and [Survival](3-Compendium/rules/skills.md#Survival).
...
The sidekick can attack twice, instead of once, whenever it takes the [Attack](3-Compendium/rules/actions.md#Attack) action on its turn.
