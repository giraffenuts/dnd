...
|-------------|-----------------|
| 3 | [Cure Wounds](3-Compendium/spells/cure-wounds-xphb.md), [Moonbeam](3-Compendium/spells/moonbeam-xphb.md), [Starry Wisp](3-Compendium/spells/starry-wisp-xphb.md) |
| 5 | [Conjure Animals](3-Compendium/spells/conjure-animals-xphb.md) |
| 7 | [Fount of Moonlight](3-Compendium/spells/fount-of-moonlight-xphb.md) |
| 9 | [Mass Cure Wounds](3-Compendium/spells/mass-cure-wounds-xphb.md) |
^circle-of-the-moon-spells
...
The maximum [Challenge Rating](3-Compendium/rules/variant-rules/challenge-rating-xphb.md) for the form equals your Druid level divided by 3 (round down).
...
You gain a number of [Temporary Hit Points](3-Compendium/rules/variant-rules/temporary-hit-points-xphb.md) equal to three times your Druid level.
...
You magically transport yourself, reappearing amid a burst of moonlight. As a [Bonus Action](3-Compendium/rules/variant-rules/bonus-action-xphb.md), you teleport up to 30 feet to an unoccupied space you can see, and you have [Advantage](3-Compendium/rules/variant-rules/advantage-xphb.md) on the next attack roll you make before the end of this turn.

You can use this feature a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](3-Compendium/rules/variant-rules/long-rest-xphb.md). You can also regain uses by expending a level 2+ spell slot for each use you want to restore (no action required).
...
Once per turn, you can deal an extra `dice:2d10|noform|avg` (`2d10`) Radiant damage to a target you hit with a Wild Shape form's attack.
