...
> <tr class="class-progression"><td class"level">3rd</td><td class"pb">+2</td><td class"feature"><a href='#The%20Fathomless%20(Level%203)'>The Fathomless</a></td></tr>
...
| Spell Level | Spells |
|-------------|--------|
| 1st | [create or destroy water](3-Compendium/spells/create-or-destroy-water-xphb.md), [thunderwave](3-Compendium/spells/thunderwave-xphb.md) |
| 2nd | [gust of wind](3-Compendium/spells/gust-of-wind-xphb.md), [silence](3-Compendium/spells/silence-xphb.md) |
| 3rd | [lightning bolt](3-Compendium/spells/lightning-bolt-xphb.md), [sleet storm](3-Compendium/spells/sleet-storm-xphb.md) |
| 4th | [control water](3-Compendium/spells/control-water-xphb.md), [summon elemental](3-Compendium/spells/summon-elemental-xphb.md) (water only) |
| 5th | [Bigby's hand](3-Compendium/spells/bigbys-hand-xphb.md) (appears as a tentacle), [cone of cold](3-Compendium/spells/cone-of-cold-xphb.md) |
^fathomless-expanded-spells
...
You learn the spell [Evard's black tentacles](3-Compendium/spells/evards-black-tentacles-xphb.md). It counts as a warlock spell for you, but it doesn't count against the number of spells you know. You can also cast it once without a spell slot, and you regain the ability to do so when you finish a long rest.

Whenever you cast this spell, your patron's magic bolsters you, granting you a number of temporary hit points equal to your warlock level. Moreover, damage can't break your [concentration](3-Compendium/rules/conditions.md#Concentration) on this spell.
