...
| 21–30 | While attuned to the Artifact, you have Immunity to the [Poisoned](3-Compendium/rules/conditions.md#Poisoned) condition. |
| 31–40 | While attuned to the Artifact, you have Immunity to the [Charmed](3-Compendium/rules/conditions.md#Charmed) and [Frightened](3-Compendium/rules/conditions.md#Frightened) conditions. |
...
| 61–70 | While attuned to the Artifact, you can cast one level 1 spell (chosen by the DM) from it. After you cast the spell, roll `dice:1d6\|noform\|avg` (`1d6`). On a roll of 1–5, you can't cast it again in this way until the next dawn. |
