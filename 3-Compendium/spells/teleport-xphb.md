...
You and your group (or the target object) appear `dice:2d12|noform|avg` (`2d12`) miles away from the destination in a random direction. Roll `dice:1d8|noform|avg` (`1d8`) for the direction: 1, east; 2, southeast; 3, south; 4, southwest; 5, west; 6, northwest; 7, north; or 8, northeast.
