...
A creature you touch regains a number of [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md) equal to `dice:2d8|noform|avg` (`2d8`) plus your spellcasting ability modifier.

**Using a Higher-Level Spell Slot.** The healing increases by `dice:2d8|noform|avg|text(2d8)` for each spell slot level above 1.
