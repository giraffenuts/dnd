...
Lightning springs from you to a creature that you try to touch. Make a melee spell attack against the target. On a hit, the target takes `dice:1d8|noform|avg` (`1d8`) Lightning damage, and it can't make Opportunity Attacks until the start of its next turn.
