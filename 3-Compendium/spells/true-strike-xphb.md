...
**Cantrip Upgrade.** Whether you deal Radiant damage or the weapon's normal damage type, the attack deals extra Radiant damage when you reach levels `dice:1d6|noform|avg|text(5)` (`1d6`), `dice:2d6|noform|avg|text(11)` (`2d6`), and `dice:3d6|noform|avg|text(17)` (`3d6`).
