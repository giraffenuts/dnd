...
---
# [Shadow Spirit](3-Compendium\bestiary\monstrosity/shadow-spirit-tce.md)
...
"traits":
- "desc": "The spirit has advantage on attack rolls against [frightened](3-Compendium/rules/conditions.md#Frightened)\
    \ creatures."
...
- "desc": "The spirit screams. Each creature within 30 feet of it must succeed on\
    \ a Wisdom saving throw against your spell save DC or be [frightened](3-Compendium/rules/conditions.md#Frightened)\
    \ for 1 minute. The [frightened](3-Compendium/rules/conditions.md#Frightened)\
...
"source":
- "TCE"
"image": "3-Compendium/bestiary/monstrosity/token/shadow-spirit-tce.webp"
```
^statblock