...
aliases: ["Fey Spirit"]
---
# [Fey Spirit](3-Compendium\bestiary\fey/fey-spirit-xphb.md)
...
- "desc": "The spirit magically teleports up to 30 feet to an unoccupied space it\
    ...
    \ Failure: The target is [Charmed](3-Compendium/rules/conditions.md#Charmed)\
...
"source":
- "XPHB"
"image": "3-Compendium/bestiary/fey/token/fey-spirit-xphb.webp"
```
^statblock