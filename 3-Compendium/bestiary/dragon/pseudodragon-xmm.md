...
"cr": "1/4"
"traits":
- "desc": "The pseudodragon has [Advantage](3-Compendium/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Constitution Saving Throw: DC 12, one creature the pseudodragon can see\
    \ within 5 feet. Failure: 5 (2d4) Poison damage, and the target has the [Poisoned](3-Compendium/rules/conditions.md#Poisoned)\
    \ condition for 1 hour. Failure by 5 or More: The [Poisoned](3-Compendium/rules/conditions.md#Poisoned)\
    \ target also has the [Unconscious](3-Compendium/rules/conditions.md#Unconscious)\
...
- "XMM"
- "XPHB"
"image": "3-Compendium/bestiary/dragon/token/pseudodragon-xmm.webp"
```
^statblock
