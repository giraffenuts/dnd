...
- "desc": "The dragon casts one of the following spells, requiring no Material components\
    ...
    \ (level 4 version)\n\n1/day each: [Create Undead](3-Compendium/spells/create-undead-xphb.md),\
    \ [Speak with Dead](3-Compendium/spells/speak-with-dead-xphb.md), [Vitriolic Sphere](3-Compendium/spells/vitriolic-sphere-xphb.md)\
    \ (level 5 version)"
  "name": "Spellcasting"
...
- "desc": "Dexterity Saving Throw: DC 21, one creature the dragon can see within\
    \ 120 feet. Failure: 33 (6d10) Poison damage, and the target has [Disadvantage](3-Compendium/rules/variant-rules/disadvantage-xphb.md)\
