...
- "desc": "The marilith has [Advantage](3-Compendium/rules/variant-rules/advantage-xphb.md)\
    \ on saving throws against spells and other magical effects."
  "name": "Magic Resistance"
- "desc": "The marilith can take one [Reaction](3-Compendium/rules/variant-rules/reaction-xphb.md)\
    \ on every turn of combat."
  "name": "Reactive"
"actions":
- "desc": "The marilith makes six Pact Blade attacks and uses Constrict."
  "name": "Multiattack"
- "desc": "Melee Attack: +10, reach 5 ft. Hit: 10 (1d10 + 5) Slashing damage plus\
...
- "desc": "Strength Saving Throw: DC 17, one Medium or smaller creature the marilith\
    ...
    \ DC 14), and it has the [Restrained](3-Compendium/rules/conditions.md#Restrained)\
