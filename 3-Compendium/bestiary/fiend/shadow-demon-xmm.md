...
- "desc": "While in [Bright Light](3-Compendium/rules/variant-rules/bright-light-xphb.md),\
    \ the demon has [Disadvantage](3-Compendium/rules/variant-rules/disadvantage-xphb.md)\
...
- "desc": "While in [Dim Light](3-Compendium/rules/variant-rules/dim-light-xphb.md)\
    \ or [Darkness](3-Compendium/rules/variant-rules/darkness-xphb.md), the demon\
