...
- "desc": "The unicorn casts one of the following spells, requiring no spell components\
    ...
    \ [Detect Evil and Good](3-Compendium/spells/detect-evil-and-good-xphb.md), [Druidcraft](3-Compendium/spells/druidcraft-xphb.md)\n\
    \n1/day each: [Calm Emotions](3-Compendium/spells/calm-emotions-xphb.md),\
    \ [Dispel Evil and Good](3-Compendium/spells/dispel-evil-and-good-xphb.md), [Entangle](3-Compendium/spells/entangle-xphb.md),\
    \ [Pass without Trace](3-Compendium/spells/pass-without-trace-xphb.md), [Word\
    \ of Recall](3-Compendium/spells/word-of-recall-xphb.md)"
  "name": "Spellcasting"
- "desc": "The unicorn touches another creature with its horn and casts [Cure Wounds](3-Compendium/spells/cure-wounds-xphb.md)\
    \ or [Lesser Restoration](3-Compendium/spells/lesser-restoration-xphb.md) on that\
    \ creature, using the same spellcasting ability as Spellcasting.\n\n3/day:\
    \ [Cure Wounds](3-Compendium/spells/cure-wounds-xphb.md), [Lesser Restoration](3-Compendium/spells/lesser-restoration-xphb.md)"
  "name": "Unicorn's Blessing (3/Day)"
- "desc": "If the unicorn fails a saving throw, it can choose to succeed instead."
  "name": "Legendary Resistance (3/Day)"
- "desc": "The unicorn has [Advantage](3-Compendium/rules/variant-rules/advantage-xphb.md)\
...
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 11 (2d6 + 4) Bludgeoning damage."
  "name": "Hooves"
- "desc": "Melee Attack: +7, reach 5 ft. Hit: 9 (1d10 + 4) Radiant damage."
  "name": "Radiant Horn"
"legendary_actions":
- "desc": "The unicorn moves up to half its [Speed](3-Compendium/rules/variant-rules/speed-xphb.md)\
...
- "desc": "The unicorn targets itself or one creature it can see within 60 feet of\
    \ itself. The target gains 10 (3d6) [Temporary Hit Points](3-Compendium/rules/variant-rules/temporary-hit-points-xphb.md),\
...
- "desc": "The region containing a unicorn's lair is changed by its presence, creating\
  ...
  "name": ""
- "desc": "- Obscuring Foliage. The unicorn and its allies have [Advantage](3-Compendium/rules/variant-rules/advantage-xphb.md)\
    \ on Dexterity ([Stealth](3-Compendium/rules/skills.md#Stealth)) checks while\
    \ within 1 mile of the lair.  \n- Positive Energy. Whenever a creature within\
    \ 1 mile of the lair regains [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md)\
    \ from a spell, it regains the maximum number of [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md)\
