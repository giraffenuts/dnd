...
- "desc": "Whenever the golem is subjected to Acid damage, it takes no damage and\
    \ instead regains a number of [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "Whenever the golem starts its turn [Bloodied](3-Compendium/rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it continues to be berserk until it is destroyed or it is no longer [Bloodied](3-Compendium/rules/variant-rules/bloodied-xphb.md)."
  "name": "Berserk"
...
- "desc": "The golem makes two Slam attacks, or it makes three Slam attacks if it\
  ...
  "name": "Multiattack"
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 10 (1d10 + 5) Bludgeoning damage\
    \ plus 6 (1d12) Acid damage, and the target's [Hit Points](3-Compendium/rules/variant-rules/hit-points-xphb.md)\
