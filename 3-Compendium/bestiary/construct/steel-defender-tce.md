...
---
# [Steel Defender](3-Compendium\bestiary\construct/steel-defender-tce.md)
...
"traits":
- "desc": "The defender can't be [surprised](3-Compendium/rules/conditions.md#Surprised)."
  "name": "Vigilant"
"actions":
...
"source":
- "TCE"
"image": "3-Compendium/bestiary/construct/token/steel-defender-tce.webp"
```
^statblock