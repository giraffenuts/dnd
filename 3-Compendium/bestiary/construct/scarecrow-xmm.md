...
"cr": "1"
"actions":
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 6 (2d4 + 1) Slashing damage, and\
...
- "desc": "Wisdom Saving Throw: DC 11, one creature the scarecrow can see within\
    ...
    \ condition until the end of the scarecrow's next turn. While [Frightened](3-Compendium/rules/conditions.md#Frightened),\
