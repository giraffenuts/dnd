...
---
# [Mighty Servant of Leuk-o](3-Compendium\bestiary\construct/mighty-servant-of-leuk-o-tce.md)
...
- "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ save, a creature takes 26 (4d12) bludgeoning damage and is knocked [prone](3-Compendium/rules/conditions.md#Prone).\
    \ On a successful save, a creature takes half as much damage and isn't knocked\
    \ [prone](3-Compendium/rules/conditions.md#Prone)."
  "name": "Crushing Leap"
"source":
- "TCE"
"image": "3-Compendium/bestiary/construct/token/mighty-servant-of-leuk-o-tce.webp"
```
^statblock