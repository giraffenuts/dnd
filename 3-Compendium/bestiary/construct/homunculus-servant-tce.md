...
---
# [Homunculus Servant](3-Compendium\bestiary\construct/homunculus-servant-tce.md)
...
- "desc": "If the homunculus is subjected to an effect that allows it to make a Dexterity\
    ...
    \ if it's [incapacitated](3-Compendium/rules/conditions.md#Incapacitated)."
  "name": "Evasion"
"actions":
...
"source":
- "TCE"
"image": "3-Compendium/bestiary/construct/token/homunculus-servant-tce.webp"
```
^statblock