...
- "desc": "The bandit casts one of the following spells, using Intelligence as the\
    ...
    \n1/day each: [Hold Person](3-Compendium/spells/hold-person-xphb.md) (level\
    \ 4 version), [Mage Armor](3-Compendium/spells/mage-armor-xphb.md) (included in\
    \ AC), [Major Image](3-Compendium/spells/major-image-xphb.md)"
  "name": "Spellcasting"
"actions":
- "desc": "The bandit makes three Dagger attacks."
  "name": "Multiattack"
- "desc": "Melee or Ranged Attack: +6, reach 5 ft. or range 20/60 ft. Hit: 8 (2d4\
    \ + 3) Piercing damage plus 10 (3d6) Poison damage."
  "name": "Dagger"
- "desc": "Constitution Saving Throw: DC 14, each creature in a 10-foot-radius [Sphere\
    ...
    \ 3) Radiant damage, and the target has the [Blinded](3-Compendium/rules/conditions.md#Blinded)\
