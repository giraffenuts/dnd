...
- "desc": "The slaad casts one of the following spells, requiring no Material components\
    ...
    \n1/day each: [Cloudkill](3-Compendium/spells/cloudkill-xphb.md), [Fly](3-Compendium/spells/fly-xphb.md),\
    \ [Plane Shift](3-Compendium/spells/plane-shift-xphb.md) (self only), [Tongues](3-Compendium/spells/tongues-xphb.md)"
  "name": "Spellcasting"
...
- "desc": "The slaad makes two Chaos Claw attacks."
  "name": "Multiattack"
- "desc": "Melee Attack: +8, reach 10 ft. Hit: 9 (1d10 + 4) Slashing damage plus\
    \ 11 (2d10) Necrotic damage. Until the start of the slaad's next turn, the target\
