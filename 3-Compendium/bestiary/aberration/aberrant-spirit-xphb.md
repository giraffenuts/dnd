...
---
# [Aberrant Spirit](3-Compendium\bestiary\aberration/aberrant-spirit-xphb.md)
...
- "desc": "At the start of each of the spirit's turns, the spirit emits psionic energy\
    \ if it doesn't have the [Incapacitated](3-Compendium/rules/conditions.md#Incapacitated)\
...
"source":
- "XPHB"
"image": "3-Compendium/bestiary/aberration/token/aberrant-spirit-xphb.webp"
```
^statblock