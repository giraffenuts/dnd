...
- "desc": "The swarm can occupy another creature's space and vice versa, and the swarm\
  ...
  "name": "Swarm"
"actions":
- "desc": "Melee Attack: +6, reach 5 ft. Hit: 8 (1d8 + 4) Piercing damage—or 6\
    \ (1d4 + 4) Piercing damage if the swarm is [Bloodied](3-Compendium/rules/variant-rules/bloodied-xphb.md)—\
