...
- "desc": "Trigger: A creature ends its turn within 5 feet of the octopus while underwater.\
    \ Response: The octopus releases ink that fills a 5-foot [Cube [Area of Effect]](3-Compendium/rules/variant-rules/cube-area-of-effect-xphb.md)\
...
- "XMM"
- "XPHB"
"image": "3-Compendium/bestiary/beast/token/octopus-xmm.webp"
```
^statblock
