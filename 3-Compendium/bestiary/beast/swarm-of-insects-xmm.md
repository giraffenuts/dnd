...
"cr": "1/2"
"traits":
- "desc": "If the swarm has a [Climb Speed](3-Compendium/rules/variant-rules/climb-speed-xphb.md),\
...
- "desc": "The swarm can occupy another creature's space and vice versa, and the swarm\
  ...
  "name": "Swarm"
"actions":
- "desc": "Melee Attack: +3, reach 5 ft. Hit: 6 (2d4 + 1) Poison damage, or 3\
    \ (1d4 + 1) Poison damage if the swarm is [Bloodied](3-Compendium/rules/variant-rules/bloodied-xphb.md)."
  "name": "Bites"
"source":
- "XMM"
```
