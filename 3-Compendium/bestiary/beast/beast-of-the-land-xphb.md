...
---
# [Beast of the Land](3-Compendium\bestiary\beast/beast-of-the-land-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ an extra 1d6 damage of the same type, and the target has the [Prone](3-Compendium/rules/conditions.md#Prone)\
    \ condition if it is a Large or smaller creature."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "3-Compendium/bestiary/beast/token/beast-of-the-land-xphb.webp"
```
^statblock