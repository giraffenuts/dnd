...
- "desc": "Dexterity Saving Throw: DC 13, one creature the spider can see within\
    \ 60 feet. Failure: The target has the [Restrained](3-Compendium/rules/conditions.md#Restrained)\
...
- "XMM"
- "XPHB"
"image": "3-Compendium/bestiary/beast/token/giant-spider-xmm.webp"
```
^statblock
