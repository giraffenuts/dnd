...
---
# [Undead Spirit](3-Compendium\bestiary\undead/undead-spirit-xphb.md)
...
- "desc": "Constitution Saving Throw: DC equals your spell save DC, any creature\
    ...
    \ from the spirit. Failure: The creature has the [Poisoned](3-Compendium/rules/conditions.md#Poisoned)\
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ has the [Poisoned](3-Compendium/rules/conditions.md#Poisoned) condition, it\
    \ has the [Paralyzed](3-Compendium/rules/conditions.md#Paralyzed) condition until\
    \ the end of its next turn."
  "name": "Rotting Claw (Putrid Only)"
"source":
- "XPHB"
"image": "3-Compendium/bestiary/undead/token/undead-spirit-xphb.webp"
```
^statblock