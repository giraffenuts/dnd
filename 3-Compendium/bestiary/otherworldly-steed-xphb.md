...
---
# [Otherworldly Steed](3-Compendium\bestiary/otherworldly-steed-xphb.md)
...
- "desc": "Wisdom Saving Throw: DC equals your spell save DC, one creature within\
    \ 60 feet the steed can see. Failure: The target has the [Frightened](3-Compendium/rules/conditions.md#Frightened)\
...
"source":
- "XPHB"
"image": "3-Compendium/bestiary/token/otherworldly-steed-xphb.webp"
```
^statblock